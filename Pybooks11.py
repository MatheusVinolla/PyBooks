...
estoque_isbn = ['123', '321']
estoque_livros = [ 
['Harry Potter', 'JK Rowling','2020','23.34','Infanto-Juvenil'] ,
['Intoxicação digital','August Cury','2022','33.33','Auto-ajuda']
]


clientes_cpf = ['123.123.123']
clientes_dados = [
['Nome','28/01/2008','nome@gmail.com','Telefone']
]
...
#LIVRO (ISBN)
l0 = existe_arquivo('livros_isbn.txt')
#LIVRO (DADOS)
l1 = existe_arquivo('livros_dados.txt')
#CLIENTES (CPF)
c0 = existe_arquivo('clientes_cpf')
#CLIENTES (DADOS)
c1 = existe_arquivo('clientes_dados')

if (l0) and (l1) and (c0) and (c1):
